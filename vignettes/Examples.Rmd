...
.data <- cbind(.data, as.data.frame(marfx(mod1, data = .data, "slavicshare")))
...
.data <- cbind(.data, as.data.frame(marfx(mod1, data = .data, "changenonslav")))
...
for (i in seq_along(variables)) {
  .data[[i]] <-
    as.data.frame(avg_marfx(mod1, names(variables)[i], data = alexseev)) %>%
